...
//             <PopoverButton className="flex items-center gap-x-1 text-sm/6 font-medium text-gray-900 ring-0 focus:ring-0 focus:outline-none cursor-pointer">
//               Product
//               <ChevronDownIcon
//                 aria-hidden="true"
...
//           <Button
//             className="inline-flex items-center gap-2 rounded-md bg-gray-700 px-3 py-1.5 text-sm/6 font-medium text-white shadow-inner shadow-white/10 focus:not-data-focus:outline-none data-focus:outline data-focus:outline-white data-hover:bg-gray-600 data-open:bg-gray-700"
//             variant="primary"
//           >
//             Log in
//           </Button>
    ...
    <header className="bg-[#EEEEEE] dark:bg-gray-900 shadow sticky top-0 z-50">
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            to="/contact"
            className="rounded-md bg-gray-700 px-4 py-2 text-sm font-medium text-white shadow hover:bg-gray-600"
          >
            Contact Us
          </Link>
        </div>
